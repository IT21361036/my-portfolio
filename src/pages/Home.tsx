  ...
  return (
    <HeroSection>
      <Content>
        ...
        >
          <Subtitle>
            Software Engineering Graduate | Sri Lanka Institute of Information Technology
          </Subtitle>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <Subtitle>
            Passionate about DevOps, C#, .NET, Angular, Computer Vision, and MERN Stack Development
          </Subtitle>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
